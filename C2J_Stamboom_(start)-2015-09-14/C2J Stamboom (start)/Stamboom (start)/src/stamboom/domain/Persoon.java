...
public class Persoon implements Serializable{
    ...
    public String getInitialen() {
        ...
        for(String firstName : voornamen)
        {
    ...
    public Gezin heeftOngehuwdGezinMet(Persoon andereOuder) {
        ...
        for(Gezin family : alsOuderBetrokkenIn)
        {
            if(((family.getOuder1() == this && family.getOuder2() == andereOuder) || (family.getOuder1() == andereOuder && family.getOuder2() == this)) && family.isOngehuwd())
            {               
                result = family;
            }
        }
    ...
    public boolean isGescheidenOp(Calendar datum) {
        ...
        for(Gezin family : alsOuderBetrokkenIn)
        {
            if(family.getScheidingsdatum() == datum)
            {
                result = true;
            }
        }
