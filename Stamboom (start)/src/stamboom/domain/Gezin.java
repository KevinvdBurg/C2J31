...
public class Gezin {
    ...
    boolean setScheiding(Calendar datum) {
        if (datum != null && this.scheidingsdatum == null && huwelijksdatum != null
    ...
    boolean setHuwelijk(Calendar datum) {
        ...
        if(this.huwelijksdatum == null && ouder1.kanTrouwenOp(datum) && ouder2.kanTrouwenOp(datum))
        {
    ...
    public boolean heeftGescheidenOudersOp(Calendar datum) {
        ...
        return this.scheidingsdatum.before(datum);
    }
}
