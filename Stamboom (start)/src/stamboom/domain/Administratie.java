...
public class Administratie {
    ...
    public Persoon getPersoon(int nr) {
        //todo opgave 1
        //aanname: er worden geen personen verwijderdfor (Persoon personen1 : this.personen) {
    ...
    public ArrayList<Persoon> getPersonenMetAchternaam(String achternaam) {
        //todo opgave 1
        ArrayList<Persoon> AchterNaamList = new ArrayList<>();
        ...
        for (Persoon persoon : personList) {
            if (persoon.getAchternaam().toLowerCase().equals(achternaam.toLowerCase())) {
                AchterNaamList.add(persoon);
            }
        }

        return AchterNaamList;
    }
    ...
    public Persoon getPersoon(String[] vnamen, String anaam, String tvoegsel,
        ...
        //todo opgave 1
        Persoon TijdelijkPersoon;
        TijdelijkPersoon = null;
        ...
        return TijdelijkPersoon;
    }

    public String setInitialen(String[] voornamen) {
        //todo opgave 1
        String TijdelijkInitialen = "";

        for (int i = 0; i < voornamen.length; i++) {
            TijdelijkInitialen += voornamen[i].toUpperCase().charAt(0) + ".";
        }
        return TijdelijkInitialen;
    }
